...
class TxnMallTest(GuapcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 GUAP:
        ...
        # First: use raw transaction API to send 1240 * 5 GUAP to node1_address,
        # but don't broadcast:
        ...
        if self.options.mine_block:
            assert_equal(tx1["guapconfirmations"], 1)
            assert_equal(tx2["guapconfirmations"], 1)
            # Node1's balance should be both transaction amounts:
            assert_equal(self.nodes[1].getbalance(), starting_balance - tx1["amount"] - tx2["amount"])
        else:
            assert_equal(tx1["guapconfirmations"], 0)
            assert_equal(tx2["guapconfirmations"], 0)
        ...
        assert_equal(tx1["guapconfirmations"], -2)
        assert_equal(tx2["guapconfirmations"], -2)
