...
#ifndef Guapcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Guapcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Guapcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
