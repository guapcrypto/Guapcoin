...
#include "qt/guapcoin/settings/forms/ui_settingswidget.h"
...
#include "qt/guapcoin/settings/settingswalletoptionswidget.h"
#include "qt/guapcoin/settings/settingsmainoptionswidget.h"
#include "qt/guapcoin/settings/settingsdisplayoptionswidget.h"
#include "qt/guapcoin/settings/settingsmultisendwidget.h"
#include "qt/guapcoin/settings/settingsinformationwidget.h"
#include "qt/guapcoin/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(GuapcoinGUI* parent) :
    PWidget(parent),
