...
#include "qt/guapcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/guapcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(GuapcoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableGUAP,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableGUAP,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableGUAP,
    ...
    connect(ui->pushButton_UnspendableGUAP, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableGUAP);});
    ...
    if (parent)
        connect(parent, &GuapcoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
