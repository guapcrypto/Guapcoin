...
"""Verify that starting guapcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import GuapcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(GuapcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start guapcoin with -? for help text")
        ...
        self.log.info("Start guapcoin with -version for version information")
