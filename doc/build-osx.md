...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Guapcoin"

    touch "/Users/${USER}/Library/Application Support/Guapcoin/guapcoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Guapcoin/guapcoin.conf"

The first time you run guapcoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/guapcoind -daemon # Starts the guapcoin daemon.
    ./src/guapcoin-cli --help # Outputs a list of command-line options.
    ./src/guapcoin-cli help # Outputs a list of RPC commands when the daemon is running.
