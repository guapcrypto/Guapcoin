...
#include "qt/guapcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(GuapcoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &GuapcoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
