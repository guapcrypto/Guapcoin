...
- [Development guidelines](#development-guidelines)
    - [General Guapcoin](#general-guapcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Guapcoin uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Guapcoin is a multi-threaded application, and deadlocks or other
...
However, in open source software such as Guapcoin, where everyone uses
...
pay attention to for reviewers of Guapcoin code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Guapcoin uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Guapcoin so that they can be integrated
