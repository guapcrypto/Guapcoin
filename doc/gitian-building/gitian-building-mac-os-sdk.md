...
The script [extract-osx-sdk.sh](https://github.com/guapcoin-project/guapcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
guapcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/guapcoin-project/guapcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
