...
The build script we'll be using is contained in the Guapcoin github repository ([contrib/gitian-build.py](https://github.com/guapcoin-project/guapcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Guapcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Guapcoin-Project/Guapcoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, guapcoin-detached-sigs, and guapcoin GitHub repos.
