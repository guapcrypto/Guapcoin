...
#include "qt/guapcoin/settings/settingsnetworkwidget.h"
#include "qt/guapcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/guapcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(GuapcoinGUI* _window, QWidget *parent) :
