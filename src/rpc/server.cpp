...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Guapcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Guapcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Guapcoin features */
        {"guapcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"guapcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"guapcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"guapcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"guapcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"guapcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"guapcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"guapcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"guapcoin", "startmasternode", &startmasternode, true, true, false},
        {"guapcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"guapcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"guapcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"guapcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"guapcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"guapcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"guapcoin", "preparebudget", &preparebudget, true, true, false},
        {"guapcoin", "submitbudget", &submitbudget, true, true, false},
        {"guapcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"guapcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"guapcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"guapcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"guapcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"guapcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"guapcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"guapcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"guapcoin", "mnsync", &mnsync, true, true, false},
        {"guapcoin", "spork", &spork, true, true, false},
        {"guapcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> guapcoin-cli " + methodname + " " + args + "\n";
}
