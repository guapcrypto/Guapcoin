...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Guapcoin features */
        {"guapcoin", "listmasternodes", &listmasternodes, true },
        {"guapcoin", "getmasternodecount", &getmasternodecount, true },
        {"guapcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"guapcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"guapcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"guapcoin", "masternodecurrent", &masternodecurrent, true },
        {"guapcoin", "startmasternode", &startmasternode, true },
        {"guapcoin", "createmasternodekey", &createmasternodekey, true },
        {"guapcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"guapcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"guapcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"guapcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"guapcoin", "getmasternodescores", &getmasternodescores, true },
        {"guapcoin", "preparebudget", &preparebudget, true },
        {"guapcoin", "submitbudget", &submitbudget, true },
        {"guapcoin", "mnbudgetvote", &mnbudgetvote, true },
        {"guapcoin", "getbudgetvotes", &getbudgetvotes, true },
        {"guapcoin", "getnextsuperblock", &getnextsuperblock, true },
        {"guapcoin", "getbudgetprojection", &getbudgetprojection, true },
        {"guapcoin", "getbudgetinfo", &getbudgetinfo, true },
        {"guapcoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"guapcoin", "mnfinalbudget", &mnfinalbudget, true },
        {"guapcoin", "checkbudgets", &checkbudgets, true },
        {"guapcoin", "mnsync", &mnsync, true },
        {"guapcoin", "spork", &spork, true },
