...
#include "qt/guapcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(GuapcoinGUI* _window, QWidget *parent) :
