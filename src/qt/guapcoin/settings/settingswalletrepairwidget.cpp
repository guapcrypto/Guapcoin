...
#include "qt/guapcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/guapcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(GuapcoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to GuapcoinGUI::handleRestart()
