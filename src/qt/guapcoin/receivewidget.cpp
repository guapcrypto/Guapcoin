...
#include "qt/guapcoin/forms/ui_receivewidget.h"
...
#include "qt/guapcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(GuapcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive GUAP."));
