...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // GUAP Total
    CAmount guapAvailableBalance = balance;
    // Set
    QString totalGuap = GUIUtil::formatBalance(guapAvailableBalance, nDisplayUnit);
    ...
    ui->labelPendingGuap->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureGuap->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
