...
#include "qt/guapcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/guapcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(GuapcoinGUI* _window, QWidget *parent) :
