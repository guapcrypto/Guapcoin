...
#include "qt/guapcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/guapcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(GuapcoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	messageInternal(CMD_REPLY, (tr("Welcome to the Guapcoin RPC console.") + "<br>" +
