...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Guapcoin Core guapcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  guapcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded guapcoin transaction") + "\n" +
                               "  guapcoin-tx [options] -create [commands]   " + _("Create hex-encoded guapcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded guapcoin transaction
