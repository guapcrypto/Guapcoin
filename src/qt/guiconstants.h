...
/* Guapcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Guapcoin"
#define QAPP_ORG_DOMAIN "guapcoin.org"
#define QAPP_APP_NAME_DEFAULT "Guapcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Guapcoin-Qt-testnet"
