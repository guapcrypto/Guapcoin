...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(GUAP);
    unitlist.append(mGUAP);
    unitlist.append(uGUAP);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case GUAP:
        return QString("guapcoin");
    case mGUAP:
        return QString("mguapcoin");
    case uGUAP:
        return QString::fromUtf8("uguapcoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GUAP:
            return QString("GUAP");
        case mGUAP:
            return QString("mGUAP");
        case uGUAP:
            return QString::fromUtf8("μGUAP");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GUAP:
            return QString("tGUAP");
        case mGUAP:
            return QString("mtGUAP");
        case uGUAP:
            return QString::fromUtf8("μtGUAP");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GUAP:
            return QString("GUAP");
        case mGUAP:
            return QString("Milli-GUAP (1 / 1" THIN_SP_UTF8 "000)");
        case uGUAP:
            return QString("Micro-GUAP (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GUAP:
            return QString("TestGUAPs");
        case mGUAP:
            return QString("Milli-TestGUAP (1 / 1" THIN_SP_UTF8 "000)");
        case uGUAP:
            return QString("Micro-TestGUAP (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
