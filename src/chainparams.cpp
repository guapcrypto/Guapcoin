...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1600673955, // * UNIX timestamp of last checkpoint block
	1237127,    // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams()
    {
       ...
       // assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));
        ...
        consensus.nTime_EnforceNewSporkKey = 1599195600;    //!> August 26, 2019 11:00:00 PM GMT
        consensus.nTime_RejectOldSporkKey = 1599285600;     //!> September 26, 2019 11:00:00 PM GMT
