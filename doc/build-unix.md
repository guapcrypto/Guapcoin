UNIX BUILD NOTES
====================
Some notes on how to build Guapcoin in Unix.

Note
---------------------
Always use absolute paths to configure and compile Guapcoin and the dependencies,
...
memory available when compiling Guapcoin. On systems with less, gcc can be
...
To build Guapcoin without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Guapcoin installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Guapcoin should be built with a non-executable stack
