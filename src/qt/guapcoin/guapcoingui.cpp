...
const QString GuapcoinGUI::DEFAULT_WALLET = "~Default";

GuapcoinGUI::GuapcoinGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void GuapcoinGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &GuapcoinGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &GuapcoinGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &GuapcoinGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &GuapcoinGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &GuapcoinGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &GuapcoinGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &GuapcoinGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::execDialog, this, &GuapcoinGUI::execDialog);
    connect(coldStakingWidget, &ColdStakingWidget::showHide, this, &GuapcoinGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &GuapcoinGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &GuapcoinGUI::execDialog);
}
...
#ifndef Q_OS_MAC
void GuapcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void GuapcoinGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
bool GuapcoinGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    connect(addressesWidget, &AddressesWidget::message,this, &GuapcoinGUI::message);
...
static bool ThreadSafeMessageBox(GuapcoinGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void GuapcoinGUI::subscribeToCoreSignals()
{
    // Connect signals to client
    uiInterface.ThreadSafeMessageBox.connect(boost::bind(ThreadSafeMessageBox, this, _1, _2, _3));
}

void GuapcoinGUI::unsubscribeFromCoreSignals()
{
