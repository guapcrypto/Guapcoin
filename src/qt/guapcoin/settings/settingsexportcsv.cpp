...
#include "qt/guapcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(GuapcoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Guapcoin_tx_csv_export(*.csv)") : tr("Guapcoin_addresses_csv_export(*.csv)"),
                                        nullptr);
