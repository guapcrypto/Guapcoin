...
#include "qt/guapcoin/forms/ui_masternodeswidget.h"
#include "qt/guapcoin/qtutils.h"
#include "qt/guapcoin/mnrow.h"
#include "qt/guapcoin/mninfodialog.h"

#include "qt/guapcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(GuapcoinGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    if (verifyWalletUnlocked()) {
        if (walletModel->getBalance() <= (COIN * 10000)) {
            inform(tr("Not enough balance to create a masternode, 10,000 GUAP required."));
            return;
        }
        showHideOp(true);
