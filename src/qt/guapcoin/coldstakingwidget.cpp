...
#include "qt/guapcoin/forms/ui_coldstakingwidget.h"
#include "qt/guapcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/guapcoin/requestdialog.h"
#include "qt/guapcoin/tooltipmenu.h"
#include "qt/guapcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(GuapcoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your GUAPs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept GUAP delegation / Delegate GUAP"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select GUAP outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 GUAP" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
