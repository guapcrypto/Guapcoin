...
#include "qt/guapcoin/coincontrolguapwidget.h"
#include "qt/guapcoin/forms/ui_coincontrolguapwidget.h"

CoinControlGuapWidget::CoinControlGuapWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlGuapWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select GUAP Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("GUAP");
    ...
    ui->labelValueAfter->setText("0.00 GUAP");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 GUAP");
    ui->labelValueFee->setText("0.00 GUAP");
...
CoinControlGuapWidget::~CoinControlGuapWidget()
{
    delete ui;
}
